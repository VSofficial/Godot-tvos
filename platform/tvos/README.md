...
project template used for packaging the Apple embedded export templates.

## Documentation

- [Compiling for Apple embedded platforms](https://docs.godotengine.org/en/latest/engine_details/development/compiling/compiling_for_ios.html)
  - Instructions on building this platform port from source.
- [Exporting for Apple embedded platforms](https://docs.godotengine.org/en/latest/tutorials/export/exporting_for_ios.html)
